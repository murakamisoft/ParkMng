...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { memo: @park.memo, name: @park.name, picture: @park.picture, play: @park.play, position: @park.position } }
    end
  ...
  test "should update park" do
    patch park_url(@park), params: { park: { memo: @park.memo, name: @park.name, picture: @park.picture, play: @park.play, position: @park.position } }
